export const senseis = [
    ...
    {
        slug: "luis-mora-salazar",
        name: "Luis Mora Salazar",
        shortDescription: "Especialista en judo infantil y categorías juveniles. Ex seleccionado nacional y campeón en -73 kg.",
        fullDescription: "Luis Mora Salazar comenzó en el judo a los 8 años en San José. Fue campeón nacional juvenil en -73 kg en 2012 y 2013, y representó a Costa Rica en el Campeonato Panamericano Juvenil de Guadalajara.\n\nTras retirarse del alto rendimiento se formó como entrenador en la Federación Costarricense de Judo. Está certificado en metodología infantil por la IJF y lleva más de seis años enfocado en las categorías de iniciación y prejuvenil.\n\nEn el dojo se encarga de las clases de niños y del programa de valores a través del judo.",
        image: "/sensei_david.jpg",
        badgeLabel: "Instructor",
        stats: [
            { label: "Años de experiencia", value: "14" },
            { label: "Títulos nacionales", value: "4" },
            { label: "Categoría", value: "-73 kg" },
        ],
    },
    ,
    {
        slug: "luis-mora-galan",
        name: "Luis Mora Galan",
        shortDescription: "Especialista en judo infantil y categorías juveniles. Ex seleccionado nacional y campeón en -73 kg.",
        fullDescription: "Luis Mora Salazar comenzó en el judo a los 8 años en San José. Fue campeón nacional juvenil en -73 kg en 2012 y 2013, y representó a Costa Rica en el Campeonato Panamericano Juvenil de Guadalajara.\n\nTras retirarse del alto rendimiento se formó como entrenador en la Federación Costarricense de Judo. Está certificado en metodología infantil por la IJF y lleva más de seis años enfocado en las categorías de iniciación y prejuvenil.\n\nEn el dojo se encarga de las clases de niños y del programa de valores a través del judo.",
        image: "/sensei_david.jpg",
        badgeLabel: "Instructor",
    ...
    ,
    {
        slug: "luis-mora-perez",
        name: "Luis Mora Perez",
        shortDescription: "Especialista en judo infantil y categorías juveniles. Ex seleccionado nacional y campeón en -73 kg.",
        fullDescription: "Luis Mora Salazar comenzó en el judo a los 8 años en San José. Fue campeón nacional juvenil en -73 kg en 2012 y 2013, y representó a Costa Rica en el Campeonato Panamericano Juvenil de Guadalajara.\n\nTras retirarse del alto rendimiento se formó como entrenador en la Federación Costarricense de Judo. Está certificado en metodología infantil por la IJF y lleva más de seis años enfocado en las categorías de iniciación y prejuvenil.\n\nEn el dojo se encarga de las clases de niños y del programa de valores a través del judo.",
        image: "/sensei_david.jpg",
        badgeLabel: "Instructor",
