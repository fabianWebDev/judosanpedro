        ...
        <section id="about-senseis" className="w-full max-w-7xl mx-auto px-4 py-6 sm:px-6 sm:py-8 md:px-8 md:py-10">
            <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-stretch">
                ...
                <div className="flex flex-col md:w-2/3">
                    ...
                    <p className="text-zinc-600 dark:text-zinc-400 mb-4 sm:mb-5 leading-relaxed">
                        {t.aboutSenseisDescription}
                    </p>
                    <Link
                        href={`/${locale}/senseis`}
                        className="inline-flex items-center justify-center rounded-md px-4 py-2 bg-zinc-900 text-zinc-100 hover:opacity-90 transition w-fit"
                    >
                        {t.commom.moreInfo}
                    </Link>
                </div>
