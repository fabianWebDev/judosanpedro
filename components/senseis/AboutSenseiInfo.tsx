    ...
    return (
        ...
        >
            ...
            <motion.div variants={item} className="flex justify-center">
                <Link
                    href={`/${locale}/senseis`}
                    className="inline-flex items-center justify-center rounded-full px-8 py-2 text-primary font-bold border border-primary border-3 hover:bg-primary hover:text-white transition w-fit"
                >
                    {linkLabel}
                </Link>
            </motion.div>
